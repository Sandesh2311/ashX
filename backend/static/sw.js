...
self.addEventListener('message', (event) => {
  ...
  if (event.data.type === 'SHOW_NOTIFICATION') {
    ...
    self.registration.showNotification(payload.title || 'AshX', {
      body: payload.body || 'New message',
      icon: '/static/images/ashx-logo.png',
      badge: '/static/images/ashx-logo.png',
